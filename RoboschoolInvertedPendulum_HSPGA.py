"""@package RoboschoolInvertedPendulum_HSPGA

This package implements the HSPGA algorithm for RoboschoolInvertedPendulum-v1 environment.
...
# log directory
log_dir = "log_file/InvertPendulum/HSPGA"+"_lr" + str(learning_rate)
