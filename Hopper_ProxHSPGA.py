"""@package Hopper_ProxHSPGA

This package implements the ProxHSPGA algorithm for Hopper-v2 environment.
...
# log directory
log_dir = "log_file/Hopper/ProxHSPGA" + '_lbd_' + str(lbd) +"_lr" + str(learning_rate)
