"""@package Swimmer_ProxHSPGA

This package implements the ProxHSPGA algorithm for Swimmer-v2 environment.
...
# initialize a neural network policy with 2 hidden layers of 32 neurons
...
# log directory
log_dir = "log_file/Swimmer/ProxHSPGA" + '_lbd_' + str(lbd) +"_lr" + str(learning_rate)
...
for k in range(10):
    ...
    # load policy
    if learn_std:
        file_name = 'swimmer_policy' + '.txt'
    else:
        file_name = 'swimmer_policy_novar' + '.txt'
