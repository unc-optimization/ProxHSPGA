"""@package Walker_ProxHSPGA

This package implements the ProxHSPGA algorithm for Walker2d-v2 environment.
...
# log directory
log_dir = "log_file/Walker/ProxHSPGA" + '_lbd_' + str(lbd) +"_lr" + str(learning_rate)
...
for k in range(10):
    ...
    # load policy
    if learn_std:
        file_name = 'walker_policy' + '.txt'
    else:
        file_name = 'walker_policy_novar' + '.txt'
