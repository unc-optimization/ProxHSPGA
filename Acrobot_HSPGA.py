"""@package Acrobot_HSPGA

This package implements the HSPGA algorithm for Acrobot-v1 environment.
...
# log directory
log_dir = "log_file/Acrobot/HSPGA" + "_lr" + str(learning_rate)
